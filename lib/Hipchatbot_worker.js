...
module.exports = function(botkit, config) {
  ...
  // We'll alias these methods since the hipchat bot since startConversation only supports "private" conversations anyway
  bot.startPrivateConversation = bot.startConversation;
